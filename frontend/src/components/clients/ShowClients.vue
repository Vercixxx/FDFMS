                ...
                <tbody class="table-group-divider">
                    <tr v-for="restaurant in restaurants" :key="restaurant.name" class="text-center align-middle">
                        ...
                        <td>
                            ...
                            <v-btn color="success" variant="outlined" class="m-2 rounded-pill" @click="editRestaurant(restaurant.name)">
                            ...
                            <!-- Button delete -->
                            <v-btn color="danger" variant="outlined" class="m-2 rounded-pill" @click="deleteConfirm(restaurant.name)">
